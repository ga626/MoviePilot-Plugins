...
const _hoisted_35 = { class: "candidate-meta" };
const _hoisted_36 = {
  key: 0,
  class: "reason"
};
...
const _hoisted_41 = { class: "audit-grid" };
const _hoisted_42 = {
  key: 0,
  class: "reason"
};
...
function cleanTitle(value) { return safe(value).replace(/\.[a-z0-9]{2,5}$/i, '').replace(/[\[\]【】()]/g, ' ').replace(/[._-]+/g, ' ').replace(/\b(2160p|1080p|720p|web[ .-]?dl|web[ .-]?rip|bluray|bdrip|remux|x26[45]|h\.?26[45]|hevc|aac|dts|atmos|hdr10?\+?|dv|10bit|proper|repack|complete|中字|简繁|国语|粤语)\b/gi, ' ').replace(/\s+/g, ' ').trim().slice(0, 120) }
...
return (_ctx, _cache) => {
  return (_openBlock(), _createElementBlock("main", _hoisted_1, [
    ...
    _createElementVNode("section", _hoisted_10, [
      _cache[14] || (_cache[14] = _createElementVNode("h2", null, "这次到底查了什么", -1)),
      _createElementVNode("div", _hoisted_11, [
        _createElementVNode("span", null, [
          _cache[10] || (_cache[10] = _createTextVNode("失败历史 ", -1)),
          _createElementVNode("b", null, _toDisplayString(scope.value.failure), 1)
        ]),
        _createElementVNode("span", null, [
          _cache[11] || (_cache[11] = _createTextVNode("成功历史 ", -1)),
          _createElementVNode("b", null, _toDisplayString(scope.value.success), 1)
        ]),
        _createElementVNode("span", null, [
          _cache[12] || (_cache[12] = _createTextVNode("失败后已成功 ", -1)),
          _createElementVNode("b", null, _toDisplayString(scope.value.recovered), 1)
        ]),
        _createElementVNode("span", null, [
          _cache[13] || (_cache[13] = _createTextVNode("当前失败候选 ", -1)),
      ...
      ? (_openBlock(), _createElementBlock("section", _hoisted_15, [
          _createElementVNode("div", _hoisted_16, [
            _cache[15] || (_cache[15] = _createElementVNode("div", null, [
              ...
              _createElementVNode("p", null, "每张卡对应一个真实来源包，不按单个文件重复计数。模型先只读目录文字提出判断，再由 MoviePilot 当前数据源核验；若源里有豆瓣，会明确显示“来源：豆瓣”。")
            ], -1)),
          ...
          (sources.value.length)
            ? (_openBlock(), _createElementBlock("details", _hoisted_18, [
                _cache[16] || (_cache[16] = _createElementVNode("summary", null, "查看数据源查询状态", -1)),
            ...
            : _createCommentVNode("", true),
          (!cards.value.length)
            ? (_openBlock(), _createElementBlock("p", _hoisted_19, "尚未读取。开始后会先建立账本，再显示每个来源包的模型判断、完整证据和官方候选。"))
            : _createCommentVNode("", true),
          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(cards.value, (card) => {
            return (_openBlock(), _createElementBlock("article", {
              ...
              _createElementVNode("div", null, [
                _createElementVNode("span", _hoisted_20, _toDisplayString(card.state === 'confirmed' ? '身份已确认' : card.state === 'needs_selection' ? '需要你确认' : card.state === 'insufficient' ? '资料不足' : card.state === 'non_media' ? '样片或测试残留' : '来源不可读取'), 1),
      ...
      : (_openBlock(), _createElementBlock("section", _hoisted_23, [
          ...
          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(confirmed.value, (card) => {
            return (_openBlock(), _createElementBlock("article", {
              ...
              _createElementVNode("div", null, [
                _cache[17] || (_cache[17] = _createElementVNode("span", { class: "state" }, "身份已确认", -1)),
            ...
            (tab.value === 'identity')
              ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                  ...
                  (selected.value.diagnosis)
                    ? (_openBlock(), _createElementBlock("section", _hoisted_28, [
                        ...
                        (selected.value.diagnosis.reasons?.length)
                          ? (_openBlock(), _createElementBlock("p", _hoisted_29, "理由：" + _toDisplayString(selected.value.diagnosis.reasons.join('；')), 1))
                          : _createCommentVNode("", true),
                        (selected.value.diagnosis.expected_episodes?.length)
                          ? (_openBlock(), _createElementBlock("p", _hoisted_30, "模型预期集号：" + _toDisplayString(selected.value.diagnosis.expected_episodes.join('、')), 1))
                          : _createCommentVNode("", true),
                        (selected.value.diagnosis.evidence_indexes?.length)
                          ? (_openBlock(), _createElementBlock("p", _hoisted_31, "支持它的目录项编号：" + _toDisplayString(selected.value.diagnosis.evidence_indexes.map(index => index + 1).join('、')), 1))
                          : _createCommentVNode("", true)
                      ]))
                    : _createCommentVNode("", true),
                  (selected.value.evidence)
                    ? (_openBlock(), _createElementBlock("details", _hoisted_32, [
                    ...
                    : _createCommentVNode("", true),
                  (selected.value.evidence)
                    ? (_openBlock(), _createElementBlock("details", _hoisted_33, [
                  ...
                  (selected.value.candidates?.length)
                        ...
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selected.value.candidates, (candidate) => {
                          return (_openBlock(), _createElementBlock("article", {
                            ...
                            _createElementVNode("div", null, [
                              ...
                              _createElementVNode("p", _hoisted_35, _toDisplayString(candidateMeta(candidate)), 1),
                              ...
                              (candidate.conflicts?.length)
                                ? (_openBlock(), _createElementBlock("p", _hoisted_36, "冲突：" + _toDisplayString(candidate.conflicts.join('；')), 1))
                                : _createCommentVNode("", true)
                            ]),
                            _createElementVNode("button", {
                              class: "secondary",
                    ...
                    : (_openBlock(), _createElementBlock("p", _hoisted_38, "MoviePilot 没有返回候选；这不代表文件为空。"))
                ], 64))
              : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                  ...
                  }, _toDisplayString(loading.value ? '正在生成…' : '重新生成预览'), 9, _hoisted_39),
                  (preview.value)
                    ? (_openBlock(), _createElementBlock("section", _hoisted_40, [
                        ...
                        (preview.value.issues.length)
                          ? (_openBlock(), _createElementBlock("p", _hoisted_42, "已锁定：" + _toDisplayString(preview.value.issues.join('；')), 1))
                          : (_openBlock(), _createElementBlock("p", _hoisted_43, "新硬链接预览完整，但仍不执行。当前 MoviePilot 不会在预览中给出旧硬链接的逐项删除清单，插件不能替它猜测或静默删除。")),
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-fc48c80f"]]);
